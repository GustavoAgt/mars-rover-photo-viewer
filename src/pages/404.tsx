...
// See more: https://codepen.io/namratapdr/pen/yLOgREo?editors=1100
const NotFound = () => {
  return (
    <>
      <div className="div_style--1">
        ...
        <h1 className="main_msg">404 Error</h1>
        <h2 className="second_msg">Couldn't launch :(</h2>
        <h3 className="third_msg">
